import { g as glob, c as createMarkdownRenderer, f as fs, m as matter } from './serve-3dd2c315.js';
export { S as ScaffoldThemeType, k as build, j as createServer, a as defineConfig, b as defineConfigWithTheme, d as defineLoader, l as init, r as resolveConfig, i as resolvePages, h as resolveSiteData, e as resolveUserConfig, n as scaffold, s as serve } from './serve-3dd2c315.js';
    ...
    async load(files) {
      ...
      for (const file of files) {
        ...
        if (cached && timestamp === cached.timestamp) {
          ...
          const url = config.site.base + normalizePath(path.relative(config.srcDir, file)).replace(/(^|\/)index\.md$/, "$1").replace(/\.md$/, config.cleanUrls ? "" : ".html");
